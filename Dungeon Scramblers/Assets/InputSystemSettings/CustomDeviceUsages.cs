        ...
        InputSystem.RegisterLayoutOverride(@"
            {
                ...
                ""extend"" : ""Joystick"",
                ""commonUsages"" : [
                    ""Movement"", ""Attack"", ""Ability0"",""Ability1"",""Ability2"",""Ability3"",""Ability4""
                ]
            }
        ");
...
public class CustomDeviceUsages : MonoBehaviour
{
    ...
    protected void OnEnable()
    {
        ...
        {
            m_Joystick = Joystick.all[joystickIndex];
            InputSystem.AddDeviceUsage(m_Joystick, usageTag);
        }
    }
    ...
    protected void OnDisable()
    {
        ...
        if (m_Joystick != null && m_Joystick.added)
            InputSystem.RemoveDeviceUsage(m_Joystick, usageTag);
        m_Joystick = null;
    }
}
